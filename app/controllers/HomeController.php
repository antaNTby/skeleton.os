...
HTML;
		...
		$this->app->view()->assign( 'LOGO256', 'LOGO256' );
		$this->app->view()->assign( 'LOGO64', 'LOGO64' );
		$this->app->view()->assign( 'base_url', __PUBLIC__ );
		$this->app->view()->assign( 'headLinks', $headlinks );

		$this->render( 'admin.tpl.html', ['PageTitle' => 'Home'] );
	}
}
